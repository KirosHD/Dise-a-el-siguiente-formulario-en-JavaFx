...
public class Controls extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Hyperlink hyperlink = new Hyperlink("Ocean Man (Musica)");
        hyperlink.setOnAction(e -> getHostServices().showDocument("https://www.youtube.com/watch?v=8_j9UtMimqI&ab_channel=AnllerLyrics"));
        ...
        textArea.setPromptText("Ingresa un texto aqui");
        ...
        Label sliderLabel = new Label("Dezlizador:");
